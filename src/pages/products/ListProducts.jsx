                        ...
                        <div className="card-body">
                            ...
                            <div className="flex items-center justify-between">
                                <div className="form-control w-full max-w-xs">
                                    ...
                                    <input type="text" placeholder="Search here" className="input input-bordered input-sm input-accent w-full max-w-xs mx-1" value={searchName} onChange={(e) => setSearchName(e.target.value)} />
                                </div>
                                <div className="form-control w-full max-w-xs">
                                    <label className="label">
                                        <span className="label-text">Description</span>
                                    </label>
                                    <input type="text" placeholder="Search here" className="input input-bordered input-sm input-accent w-full max-w-xs mx-1" value={searchDescription} onChange={(e) => setSearchDescription(e.target.value)} />
                                </div>
                                <div className="form-control w-full max-w-xs">
                                    <label className="label">
                                        <span className="label-text">Price</span>
                                    </label>
                                    <input type="text" placeholder="Search here" className="input input-bordered input-sm input-accent w-full max-w-xs mx-1" value={searchPrice} onChange={(e) => setSearchPrice(e.target.value)} />
                                </div>
                            </div>
                            ...
                            <table className="table table-striped mt-3">
                                <thead>
                                    <tr>
                                        <th className='text-center' onClick={() => handleSort('id')}>ID</th>
                            ...
                            <div className="divider">Paginate</div>
